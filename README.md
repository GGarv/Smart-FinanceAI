...
Developed using Next.js, the application showcases prominent prompt assistance features, including a robust Financial tracking functionality. The system leverages a Firebase database, implements Fireauth authentication, and integrates the LLM Model GPT 3.5  to enhance the functionality of the AI financial advisory platform.
...
```bash
git clone https://github.com/GGarv/Smart-Finance
